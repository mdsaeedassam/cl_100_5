...
like_button = "<button class='btn btn_warning' id="firebase_message_id+"valne="+like+"onlick='updatalike(this.id)'>";
span_with_tag = "<span class=glyphicon glyaphicon-thmds-up'>Like:"+like+"</span></button><hr>";
